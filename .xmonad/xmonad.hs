...
myKeys = 
 ...
 -- Swap focused window with next window
    ...
    ("M-r", spawn "rofi -modi drun -show drun -display-drun 'Apps : ' -line-padding 4 -columns 2 -padding 50 -hide-scrollbar -show-icons -drun-icon-theme 'Paper-Mono-Dark' -font 'UbuntuMono Nerd Font Regular 14'"),
...
main = do
    ...
    xmonad $ ewmh def {
        ...
        logHook = workspaceHistoryHook <+> dynamicLogWithPP xmobarPP {
            ...
            ppCurrent = xmobarColor "#1556d6" "" . wrap "[" " ]",
            -- Visible but not current workspace
            ppVisible = xmobarColor "#1556d6" "",
            -- Hidden workspaces in xmobar
            ppHidden = xmobarColor "#3963b8" "",
            -- Hidden workspaces (no windows)
            ppHiddenNoWindows = xmobarColor "#56637d" "",
            -- Title of active window in xmobar
            ppTitle = xmobarColor "#215cd1" "" . shorten 55,
            -- Separators in xmobar
            ppSep = "<fc=#666666> | </fc>",
            -- Urgent workspace
            ppUrgent = xmobarColor "#10b356" "" . wrap "" "!",
